...
<<<<<<< HEAD
    ...
    pub(crate) async fn request_guild_members(&mut self, guild_id: u64, query: &str, limit: u64, user_ids: Option<Vec<u64>>, nonce: Option<&str>) -> Result<()> {
        self.send_json(
            &json!({
    ...
    pub(crate) async fn update_voice_state(&mut self, guild_id: u64, channel_id: Option<u64>, self_mute: bool, self_deaf: bool) -> Result<()> {
        self.send_json(
            &json!({
